...
if point_distance(x,y,global.player.x,global.player.y) < 256 {
	...
	for (var l=0; l<25; l+=1) {
		if l == 24 {
			draw_line_width_color(last_x,last_y,global.player.x,global.player.y, 5,c_purple,c_fuchsia)
		} else {
			...
			draw_line_width_color(last_x,last_y,next_x,next_y,5, c_purple,c_fuchsia)
			last_x = next_x
			last_y = next_y
		}
	}
