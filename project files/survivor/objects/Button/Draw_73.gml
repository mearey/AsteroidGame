...
draw_text_transformed_color(x-image_index/13+lengthdir_x(5,point_direction(x,y,mouse_x,mouse_y)),y-image_index/13+lengthdir_y(5,point_direction(x,y,mouse_x,mouse_y)),text, 1, 1, 0, c_red, c_red, c_red, c_red, image_index/20)
draw_text_transformed_color(x+image_index/13+lengthdir_x(5,point_direction(x,y,mouse_x,mouse_y)),y+image_index/13+lengthdir_y(5,point_direction(x,y,mouse_x,mouse_y)),text, 1, 1, 0, c_aqua, c_aqua, c_aqua, c_aqua,image_index/20)
